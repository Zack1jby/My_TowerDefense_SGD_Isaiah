...
public class CarrierEnemy : Enemy
{
    ...
    public void Initialize(Transform inputEndPoint, List<GameObject> heldEnemies)
    {
    ...
    protected void SpawnEnemy(GameObject enemyPrefab)
    {
        ...
        GameObject enemyInstance = Instantiate(enemyPrefab, spawnPos, transform.rotation);
